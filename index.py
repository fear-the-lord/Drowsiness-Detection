...
Label(root, text="DROWSINESS DETECTION",font=("times new roman",20),fg="white",bg="maroon",height=2).grid(row=2,rowspan=2,columnspan=5,sticky=N+E+W+S,padx=5,pady=10)
